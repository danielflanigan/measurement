# ToDo: move this into core.py and load class names from disk.
"""
...
It is the root of the measurement import tree, so to avoid circular imports it may not import from `measurement`.
"""
...
_unversioned = {'Dictionary': 'measurement.io.dictionary.Dictionary',
                'Netcdf': 'measurement.io.netcdf.Netcdf',
                'NpyJson': 'measurement.io.npyjson.NpyJson'
                }
