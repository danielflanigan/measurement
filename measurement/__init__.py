"""
The main goals of this package are (1) to provide data container classes that define a format and may include basic
...
The IO abstract class in the core.py module controls reading to and writing from disk. Implementations of this class
must implement its abstract methods using some data format.
